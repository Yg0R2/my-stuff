...
public class Tasks {
	...
	private static Logger _logger = LoggerFactory.getLogger(Tasks.class);
	...
	public Tasks(String dataFileName, String timeZoneFileName) throws SQLException, IOException {
